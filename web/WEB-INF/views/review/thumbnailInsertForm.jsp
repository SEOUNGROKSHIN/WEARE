...
<!-- /GNB -->
   ...
   <div class="outer outer-thumbnail-insert">
      ...
      <form action="${ pageContext.servletContext.contextPath }/review/insert" method="post" encType="multipart/form-data">
         ...
         <div class="thumbnail-insert-area">
            <table align="center">
               ...
               <tr>
                  ...
                  <td colspan="3">
                     <div class="title-img-area" id="titleImgArea">
                        <img id="titleImg" width="380" height="200">
                     </div>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  <td>사진 메모</td>
                  <td colspan="3">
                     <textarea name="body" rows="5" cols="45" style="resize:none;"></textarea>
                  </td>
               </tr>
            </table>
         ...
         <br>
         <div class="thumbnail-btn-area" align="center">
