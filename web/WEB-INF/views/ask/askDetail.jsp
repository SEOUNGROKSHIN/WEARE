...
<!-- /GNB -->
   ...
   <section id="aa-catg-head-banner">
     ...
     <!--main content start-->
        <h1><i class="fa fa-angle-right"></i>문의 상세 보기</h1>
         <div class="outer outer-notice-list">
		<h2 align="center">문의 상세 보기</h2>
		<div class="table-area">
			<form action="${ pageContext.servletContext.contextPath }/board/update" method="post">
				<table align="center">
					<tr>
						<td>제목</td>
						<td><input type="text"  value="${requestScope.ask.title}" size="50" name="title"></td>
					</tr>
					<tr>
						<td>작성자</td>
					...
					<tr>
						<td>내용 </td>
					<td colspan="3">
						<textarea style="width:150px; height:200px;"><c:out value="${ requestScope.ask.body }"/></textarea>
					</td>
					</tr>
				...
				<br>
				<div align="center">
					<button type="reset" id="cancelAsk">취소하기</button>
					<button type="submit" value="${ board.no }">수정하기</button>
					<button id="askDelete" value="${ board.no }">삭제하기</button>
				</div>
			</form>
		</div>
	</div>
